...
namespace Chess.Classes
{
    ...
    {
        public King(int rowstartingposition, int columnstartingposition, Color color)
        {
        ...
        public void MovableTiles(Grid chesstable)
        {
            ...
            SetTag(RowPosition + 1, ColumnPosition + 1);
            SetTag(RowPosition + 1, ColumnPosition);
            SetTag(RowPosition + 1, ColumnPosition - 1);
            SetTag(RowPosition - 1, ColumnPosition + 1);
            SetTag(RowPosition - 1, ColumnPosition);
            SetTag(RowPosition - 1, ColumnPosition - 1);
            SetTag(RowPosition, ColumnPosition + 1);
            SetTag(RowPosition, ColumnPosition - 1);
